  ...
  return (
    <div className="space-y-14">
      ...
      <section className="grid items-stretch gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="relative flex flex-col justify-center overflow-hidden rounded-2xl border border-ink-200 bg-white p-8 sm:p-10 lg:p-12">
          ...
          <div className="relative">
            ...
            <h1 className="mt-5 max-w-[14ch] font-display text-4xl font-bold leading-[1.05] text-ink-900 sm:text-5xl lg:text-6xl">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Link
                href="/search"
                className="group inline-flex items-center gap-2 rounded-full bg-brand px-6 py-3 text-sm font-semibold text-brand-fg shadow-pop transition-all hover:bg-brand-800 active:scale-[0.98]"
              >
                Start shopping
        ...
        >
          {hero ? (
            ...
            <div className="flex h-full items-center justify-center bg-gradient-to-br from-brand-700 via-brand-600 to-brand-900 p-10">
              <div className="bg-dotted pointer-events-none absolute inset-0 opacity-20" />
              <div className="relative text-center text-brand-fg">
                ...
                <p className="mt-1 text-sm text-brand-100">Handpicked from sellers across the country.</p>
              </div>
            </div>
          )}
        </Link>
      ...
      {/* Trust strip — utility bar, not boxed cards. */}
      <section className="reveal grid grid-cols-2 divide-ink-200 rounded-2xl border border-ink-200 bg-white sm:grid-cols-4 sm:divide-x">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
          {categories.map((c) => (
            <Link
              ...
              className="group flex items-center gap-3 rounded-xl border border-ink-200 bg-white p-3.5 transition-all hover:-translate-y-0.5 hover:border-brand-200 hover:shadow-card sm:flex-col sm:items-start sm:gap-2"
            >
      ...
      {/* New arrivals. */}
      <section>
        <div className="reveal mb-5 flex items-end justify-between">
